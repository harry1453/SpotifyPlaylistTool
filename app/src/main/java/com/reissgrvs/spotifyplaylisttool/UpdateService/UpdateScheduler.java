...
public class UpdateScheduler {
    ...
    private static final String REMINDER_JOB_TAG = "multiplaylist_update_tag";

    private static boolean sInitialized;

    synchronized public static void scheduleMultiplaylistUpdate(@NonNull final Context context) {
        Log.d("Schedule", "We've got a schedule to keep");
